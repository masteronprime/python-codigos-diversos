# -*- coding: utf-8 -*-
"""
Created on Wed Dec 21 17:43:44 2022
...
for i in calendario:
    for j in range(0, 3):
        print(i[j])
  #  print(f"¨{nombreMes(mes):30}",end=" ")
 #  print(f"¨{nombreMes(mes+1):30}",end=" ")
 #   print(f"¨{nombreMes(mes+2):30}",)
    
  #  print(f"{'Lu│Ma│Mi│Ju│Vi│Sa│Do':30}",end=" ")
  #  print(f"{'Lu│Ma│Mi│Ju│Vi│Sa│Do':30}",end=" ")
 #   print(f"{'Lu│Ma│Mi│Ju│Vi│Sa│Do':30}")
